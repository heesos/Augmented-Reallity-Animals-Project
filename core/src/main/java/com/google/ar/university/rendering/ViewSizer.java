 ...
 * com.google.ar.university.Scene}. The final size that the view is displayed at will be the size
 * from this {@link ViewSizer} scaled by the {@link com.google.ar.university.Node#getWorldScale()} of
 * the {@link com.google.ar.university.Node} that the {@link ViewRenderable} is attached to.
 */

public interface ViewSizer {
  /**
   * Calculates the desired size of the view in the {@link com.google.ar.university.Scene}. {@link
