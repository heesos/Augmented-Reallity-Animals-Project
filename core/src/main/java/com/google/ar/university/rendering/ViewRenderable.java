...
import com.google.ar.university.collision.Box;
...
import com.google.ar.university.resources.ResourceRegistry;
import com.google.ar.university.utilities.AndroidPreconditions;
import com.google.ar.university.utilities.Preconditions;
...
/**
 * Renders a 2D Android view in 3D space by attaching it to a {@link com.google.ar.university.Node}
 * with {@link com.google.ar.university.Node#setRenderable(Renderable)}. By default, the size of the
 * view is 1 meter in the {@link com.google.ar.university.Scene} per 250dp in the layout. Use a
 * {@link ViewSizer} to control how the size of the view in the {@link
 * com.google.ar.university.Scene} is calculated.
 *
 * <pre>{@code
...
public class ViewRenderable extends Renderable {
   ...
   * com.google.ar.university.Node} it is attached to. The default value is CENTER.
   */
   ...
   * com.google.ar.university.Node} it is attached to. The default value is BOTTOM.
   */
   ...
   * com.google.ar.university.Scene}.
   */
   ...
   * positioned relative to the {@link com.google.ar.university.Node} it is attached to along the
   ...
   * relative to the {@link com.google.ar.university.Node} it is attached to along the y-axis. The
   ...
   * com.google.ar.university.Node} and scales it to size it appropriately based on the meters to
  ...
  public static final class Builder extends Renderable.Builder<ViewRenderable, Builder> {
     ...
     * {@link com.google.ar.university.Scene}.
     */
