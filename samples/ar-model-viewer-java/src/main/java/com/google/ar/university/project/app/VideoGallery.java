...
public class VideoGallery extends AppCompatActivity implements RecyclerViewAdapter.clickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String filePath = Environment.getExternalStorageDirectory().getPath()+"/Pictures/Sceneform/";
...
//                recyclerViewAdapter.notifyDataSetChanged();
                ...
                new androidx.appcompat.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(VideoGallery.this,
    ...
    public void onThumbnailClick(int position) {
        Intent intent=new Intent(VideoGallery.this,VideoPlayer.class);
        intent.putExtra("movieName",Constant.allMediaList.get(position).getPath());
